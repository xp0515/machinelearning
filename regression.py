...
with open("/Users/serenazhang/Desktop/Course materials/capstone/dataset/LGA_Everything/16260.csv") as f:
...
with open("/Users/serenazhang/Desktop/Course materials/capstone/dataset/LGA_Everything/16260.csv") as f:
    ...
    for row in reader:
        ...
        if datetime(2018, 1, 11) <= a <= datetime(2018, 1, 17):
            ...
            if j1 == 1:
                row['timing_negative'] = 0
            else: row['timing_negative'] = n1/(j1 - 1)
            print(row)
            new_list.append(row)
...
with open('/Users/serenazhang/Desktop/Course materials/capstone/dataset/LGA_Everything/16260new.csv', 'w', newline='') as f:
